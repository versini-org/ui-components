...
const CommonTemplate = ({
  ...
  <!-- ... -->
			...
			<p>
				...
				because it looks weird jumping right to a heading.
			</p>
			<h4>
...
export const Basic: Story<any> = () => (
	<div className="prose prose-dark dark:prose-lighter">
		<h1>Typography</h1>
		<p>
			To use the custom typography styles provided by UI Components, you need to
			use and configure Tailwind accordingly.
		</p>
		<h2>Installation</h2>
		<p>
